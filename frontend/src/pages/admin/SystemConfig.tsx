...
import {
  ...
  Divider, Tooltip, Space, Tag, InputNumber, Select
} from 'antd';
import {
...
const defaultConfig: SystemConfig = {
  ...
  platform_name: 'Token Hub - 目前科技',
  platform_logo: '/logo.png',
  contact_phone: '400-xxx-xxxx',
  contact_email: 'support@hsall.tech',
    ...
    <div>
      <div style={{ marginBottom: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p style={{ margin: '8px 0 0', color: '#888' }}>董董专用：配置所有平台运行所需的API密钥、账户信息和系统参数</p>
        </div>
        <Space>
        ...
        <Tabs type="card" defaultActiveKey="alipay">
          ...
          <TabPane tab="🔴 ModelRouter" key="modelrouter">
            <Card title="阿里云 ModelRouter 配置" extra={renderStatus('ModelRouter')}>
              ...
              <Form.Item
                name="model_router_enabled"
                valuePropName="checked"
                label="启用 ModelRouter"
              >
                <Switch checkedChildren="启用" unCheckedChildren="关闭" />
              </Form.Item>
              ...
              >
                <Input placeholder="LTAI5t8xxxxxxxxxxxx" />
              </Form.Item>
              ...
              <Form.Item
                name="model_router_discount"
                label="采购折扣率 (%)"
                tooltip="从 ModelRouter 采购 Token 的折扣，如 65 表示 6.5 折"
              >
              ...
              <Alert
                message="折扣说明"
                description="假设 ModelRouter 官方定价为 1元/千Token，折扣率 65% 表示您的采购成本为 0.65元/千Token。您可以在套餐定价中设置自己的零售价（如 1元/千Token），赚取差价。"
                type="info"
                showIcon
              />
          ...
          <TabPane tab="🟡 平台信息" key="platform">
            <Card title="平台基本信息">
              <Form.Item
                ...
                label="平台名称"
              >
                <Input placeholder="Token Hub - 目前科技" />
              </Form.Item>
              ...
              <Form.Item
                ...
                label="客服邮箱"
              >
                <Input placeholder="support@hsall.tech" />
              </Form.Item>
